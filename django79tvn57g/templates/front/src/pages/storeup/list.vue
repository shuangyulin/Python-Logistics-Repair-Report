<template>
	<div :style='{"width":"100%","padding":"20px 16%","margin":"10px auto","position":"relative","background":"none"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"margin":"0px auto","color":"#7D9E38","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250109/81fff2a86ca447b9b35a496b2956a83e.png) center center/100% 100%","flexDirection":"column","display":"flex","width":"400px","lineHeight":"120px","fontSize":"28px","fontWeight":"bold"}'>我的收藏</div>
