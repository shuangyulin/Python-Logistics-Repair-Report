<template>
	<div class="center-preview">
		...
		<div class="center-info">
			...
			<div class="img-box" v-if="userTableName=='shenpiyuan'">
				<img :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')">
			</div>
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.center-preview {
		padding: 60px 0;
		margin: 10px auto;
		background: url(http://codegen.caihongy.cn/20250120/705c0de57674463d9bdca2e76891dfbe.png) top left/100% 480px no-repeat;
		width: 100%;
		position: relative;
		.center-title {
			margin: 0px auto;
